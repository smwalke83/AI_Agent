...
All paths you provide should be relative to the working directory. You do not need to specify the working directory in your function calls as it is automatically injected for security. For example, if the working directory is ./calculator, and you want to view the contents of calculator/main.py, the file path you provide will be main.py, not calculator/main.py or ./calculator/main.py.
